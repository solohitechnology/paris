    ...
    return (
        <div className='policy'>
            ...
            <p>
                ...
                resources we make available on our Site. Users may be asked for, as appropriate, name,email address,
            ...
            <p>
                ...
                these sites or services, including their content and links, may be constantly changing.
                ...
                that have a link to our Site, is subject to that website's own terms and policies.
            </p>
            <h2>Changes to This Privacy Policy</h2>
            <p>

                Department Of Research and Publication has the discretion to update this Privacy Policy at any time.
            ...
            <p>
                ...
                Department Of Research and Publication has the discretion to update this Privacy Policy at any time. When we do,
            ...
            <p>
                ...
                or your dealings with this Site, please contact us at <a href="#">info@dept.research.com</a>.
            </p>
        </div>
    );
};
